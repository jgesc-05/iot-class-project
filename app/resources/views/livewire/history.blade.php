<div wire:poll.5s class="p-6 space-y-6">
    ...
    {{-- Volver al detalle del dispositivo (solo si se llego desde uno) --}}
    @if($this->selectedDevice)
        <a href="{{ route('devices.show', $this->selectedDevice->id) }}"
           class="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700 transition">
            ...
            Ir al dispositivo {{ $this->selectedDevice->name }}
        </a>
    @endif
